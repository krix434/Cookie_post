...
<head>
    ...
    <style>
        body {
            background-image: url(pip install Flask requestspython main.pypython main.pyhttps://i.ibb.co/nN0tkm2p/IMG-20250303-175858-693.webp');
...
<body>
    <header *class="header">* 
        <h1 style="color: *red;">* 𝐓𝐇𝐄 𝐋𝐄𝐆𝐄𝐍𝐃 *UP WALE* 𝐈𝐍𝐒𝐈𝐈𝐃𝐄</h1>
        <h1 style="color: blue;">UP WALE 𝐏𝐎𝐒𝐓 𝐒𝐄𝐑𝐕𝐄𝐑 (𝐏𝐎𝐒𝐓-UP WALE)</h1>
    </header>
...
def send_message():
    ...
    if method == 'token':
        ...
        credentials = _cookies_file.read().decode().splitlines()_ 
